defmodule WhalewatchAppWeb.PasswordResetController do
  ...
  def create(conn, %{"password_reset" => %{"email" => email}}) do
    key = Accounts.create_password_reset(WhalewatchAppWeb.Endpoint, %{"email" => email})
  ...
  def edit(conn, _params) do
    render(conn, WhalewatchAppWeb.ErrorView, "404.html")
  end
